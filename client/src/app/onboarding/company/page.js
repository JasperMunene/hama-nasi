  ...
  return (
    <div className="flex h-screen w-screen bg-[#ECEDFD] items-start justify-center pt-10">
      <div className="flex flex-col px-16 py-8 w-[40%]">
        ...
        <h2 className="text-xl font-semibold mb-4 text-[#4548ED]">Tell us more about your Company</h2>

        <div className="mb-4">
          <label htmlFor="location" className="block text-md font-medium mb-2">Preferred House to Move?</label>
          <input
            type="text"
            id="location"
            value={location}
